...
This folder contains the original cpcv mark used by the Windows tray and
status window.

- `cpcv-logo.png` is the 512px transparent PNG for the status UI and docs.
- `cpcv-tray.ico` contains 16, 20, 24, 32, 40, 48, 64, 128, and 256px
  icon images for Windows notification-area scaling.
- `cpcv-logo-chromakey.png` is the original generated source on a magenta
  chroma-key background. It is retained so the transparent derivative can be
  reproduced and audited.

The mark was generated as original project artwork for cpcv: a clipboard,
